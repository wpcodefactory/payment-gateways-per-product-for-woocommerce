...
class ComposerStaticInitWPFactoryPaymentGatewaysPerProductCategoriesForWooCommerce
{
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->classMap = ComposerStaticInitWPFactoryPaymentGatewaysPerProductCategoriesForWooCommerce::$classMap;
